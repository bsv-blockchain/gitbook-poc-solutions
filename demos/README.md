...
| **Token Economy** | Token Transfer | This proof of concept demonstrates token-based file sharing on BSV blockchain. Users earn tokens by uploading files and spend tokens to access others' content. Built with Metanet Desktop wallet integration and PushDrop protocol, it showcases practical token minting, transfer mechanisms, and value exchange systems within a decentralized file-sharing platform. | [Business](demo-catalog/token-transfer/business-token-transfer.md)  | Sep 2025 |
